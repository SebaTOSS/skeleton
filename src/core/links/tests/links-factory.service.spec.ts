...
class DummyService extends AbstractLinkService {
  ...
  getLinks(resource: ResourceDTO, permission: any[]): object {
    return {};
  }
...
describe("Links Factory Service", () => {
  ...
  beforeEach(async () => {
    ...
    serviceFactory = moduleRef.get<LinksFactoryService>(LinksFactoryService);
  ...
  it("should create links", () => {
    ...
    expect(dummyService.getLinks).toHaveBeenCalledWith(resource, permissions);
  });
