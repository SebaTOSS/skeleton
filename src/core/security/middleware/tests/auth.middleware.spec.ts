...
describe('Auth middleware', () => {
    ...
    beforeEach(() => {
        ...
        authMiddleware = new AuthMiddleware(cacheService, apiKeyService, responseService);
    });
    ...
    it('should handle a not found', async () => {
        ...
        jest.spyOn(responseService, 'getErrorResponse');
        ...
        expect(responseService.getErrorResponse).toHaveBeenCalled();
    });
    ...
    it('should handle a unknown error', async () => {
        ...
        expect(res.type).toHaveBeenCalledWith('application/json');
        expect(res.json).toHaveBeenCalled();
        expect(responseService.getErrorResponse).not.toHaveBeenCalled();
    });
});
