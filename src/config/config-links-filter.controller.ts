import { Body, Controller, Delete, Get, HttpCode, Post, UseGuards, UseInterceptors, UsePipes } from '@nestjs/common';
...
export class ConfigLinksFilterController {
    ...
    async get(): Promise<any> {
        ...
        return this.responseService.getSuccessResponse(objects);
    }
